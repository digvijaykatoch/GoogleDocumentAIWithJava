...
/*
 ...
 String processorId = "7fd47d3f11dd857b";
 String filePath = "path/to/input/file.pdf";
 quickStart(projectId, location, processorId, filePath);
*/

String projectId = "poc-flutter-with-doc-ai";
 String location = "us"; // Format is "us" or "eu".
 String processorId = "7fd47d3f11dd857b";
 String filePath = "C:\\Users\\digvijaysingh.katoch\\Pictures\\oLD\\invoice.pdf"; //Change path as needed
 quickStart(projectId, location, processorId, filePath);
